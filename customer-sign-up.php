...
<div class="signup-page">
  <div class="small-container">
    ...
    <div class="row">
      <div class="col-2">
        <h1> SIGN UP </h1>
        <p>Don't have an account? Sign Up now! Just take a few minutes to create your own account.</p>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-2">
        <div class="form-container">
          ...
          <!-- sign up form -->
          <form class="sign-up" id="SignupForm" action="customer-sign-up-2.php" method="post" enctype="multipart/form-data">

            <label for="username">Username</label> <span style="color:#ff0000">*</span>
            <input type="email" class="form-control "
             id="cust_id" name="cust_id" placeholder="enter email" required>

            <label for="name">Name</label> <span style="color:#ff0000">*</span>
            <input class="form-control" type="text" placeholder="enter your name" id="cust_name" name="cust_name" value="">

            <label for="cust_gender">Gender</label> <span style="color:#ff0000">*</span>
            <div class="row">
                <div class="form-check">
                  <input type="radio" class="form-check-input" name="cust_gender" id="cust_gender" value="Male" required>
            ...
            <div class="row">
              <div class="form-check">
                <input type="radio" class="form-check-input" name="cust_gender" id="cust_gender" value="Female" required>
                <label for="female" class="form-check-label">Female</label>
              </div>
            </div>

            <label for="">User group</label>
            <select class="form-control" name="cust_user_group">
              <option value="user">User</option>
            </select>

            <label for="password">Password</label> <span style="color:#ff0000">*</span>
            <input type="password" class="form-control "
             id="cust_access_code" name="cust_access_code" placeholder="use a strong password" required>

             <a href="customer-login-1.php">Already have an account?</a>
