  ...
  <div class="container">
    <div class="row">
      <div class="topbar col-lg-12 col-md-12">
        ...
        <a class="navbar-brand" href="dashboard.php"> <img src="images/logo3.png" width="125px" alt=""> </a>
          ...
          if($_REQUEST['status']=="pass"){
            ...
            ?>
                ...
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                  ...
                  <br />
                  <a href="delete-product-1.php" class="btn btn-success">Delete Another Record</a>
                </div>
            ...
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
              <h2>Deleting the Record Failed!</h2>
