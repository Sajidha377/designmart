  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-8 col-md-8">
        ...
        <h1 class="display-4">Admin Sign Up</h1>

        <div class="col-lg-5 col-md-5">

        <form class="" action="admin-sign-up-2.php" method="post">
          ...
          <div class="form-row align-item-left">
            ...
            <div class="form-group col-lg-12 col-md-12">
               <label class="label mx-1" for="name">Gender</label>
               <div class="input-group mx-1 mb-2 ">
                 <div class="input-group-prepend">
                   <div class="input-group-text">
                     <i class="fas fa-user"></i>
            ...
            <div class="form-group col-lg-12 col-md-12">
               <label class="label mx-1" for="name">User Group</label>
               <div class="input-group mx-1 mb-2 ">
                 <div class="input-group-prepend">
                   <div class="input-group-text">
