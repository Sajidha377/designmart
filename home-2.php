...
<!-- logo -->
<a class="navbar-brand" href="home-2.php"> <img src="images/logo.png" alt="" width="125px"> </a>
...
<ul class="navbar-nav mr-auto">
  <li class="nav-item active">
    <a class="nav-link" style="color:#132e5b;" href="home-2.php">Home <span class="sr-only">(current)</span></a>
  </li>
  <li class="nav-item">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <br>
          <form class="form-control" action="customer-edit-1.php" method="post" enctype="multipart/form-data">

               <a href="customer-edit-1.php">Edit Account</a>
               <br>
...
<h5>Make your special occasions extra special with our collections of clothing.</h5>
  ...
  Sri Lanka.</p> <br>
  <p>As a pioneer we offer the most high end traditional wears from simple to most luxurious designs, <br>
    to uplift the fashion sense and personalities of our customers. Every new collection from all the <br>
    categories are instantly available at our stores, so our customers can move on with the prevailing trends.</p>
