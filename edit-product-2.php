  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-8 col-md-8">
        ...
        <h1 class="display-4">Update/Edit a Product</h1>
        <form class="form" action="edit-product-3.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-row align-item-left">
             <div class="form-group col-lg-6 col-md-6">
                ...
                <div class="input-group mx-1 mb-2 ">
                  ...
                  <input type="submit" class="form-control btn btn-success" name="submit" id="submit" value="SAVE CHANGES">
          ...
          <div class="alert alert-danger alert-dismissible fade show" role="alert">
            ...
            <br />
            <a href="edit-product-1.php" class="btn btn-danger">Try Again</a>
          </div>
          <?php
        }
