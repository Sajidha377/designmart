...
<ul class="navbar-nav mr-auto">
  <li class="nav-item">
    <a class="nav-link" href="home-2.php">Home </a>
  </li>
  <li class="nav-item">
    ...
    <div class="row">
      <div class="col-2">
        <div class="form-container">
          ...
          <!-- sign up form -->
          <form class="edit" action="customer-edit-2.php" method="post" enctype="multipart/form-data">

            <label for="username">Username</label> <span style="color:#ff0000">*</span>
            <input type="email" class="form-control" id="cust_id" name="cust_id" placeholder="enter email" required>
