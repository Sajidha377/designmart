  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-8 col-md-8">
        ...
        <form class="form" action="add-product-2.php" method="post" enctype="multipart/form-data">

          <div class="form-row align-item-left">
             <div class="form-group col-lg-6 col-md-6">

                <label class="label mx-1" for="name">Product Name</label>
          ...
          <div class="form-row align-item-left">
             <div class="form-group col-lg-6 col-md-6">
                ...
                <div class="input-group mx-1 mb-2 ">
                  ...
                  <input type="submit" class="form-control btn btn-success" name="submit" id="submit" value="ADD NOW">
