...
<html>
  <head>
    <title>Design Mart | Categories | shawls</title>
...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/shawl-banner.png" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/shawl-banner1.png" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/shawl-banner2.png" alt="Third slide">
    </div>
  </div>
</div>
<!-- end of banner -->
...
<div class="small-container">
  <h1>Shawl</h1>
  <p>Dupatta is one of the vital element of the traditional wears, which can be worn
    with kurtis, shalwars, cholis etc. Shawl brings in a perfect look and completion
    when worn with shalwars and kurtis.</p>
</div>
  ...
  <div class="small-container">
    ...
    while($row = mysqli_fetch_assoc($rs)){
      ...
      ?>
        ...
        <div class="col-4">
          <a data-fancybox="gallery" href="images/large/<?php echo $row['picture']; ?>"><img src="images/large/<?php echo $row['picture']; ?>" alt="" data-toggle="modal" data-target="#imageModal2" width="230px"></a>
          <table>
            <tr>
