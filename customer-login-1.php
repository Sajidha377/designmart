...
<div class="signup-page">
  <div class="small-container">
    ...
    <div class="row">
      <div class="col-2">
        <h1> LOGIN </h1>
        <p>Login to your account easily and access more features.</p>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-2">
        <div class="form-container">
          ...
          <!-- sign up form -->
          <form class="sign-up" id="SignupForm" action="customer-login-2.php" method="post">
            ...
            <input type="password" class="form-control "
             id="cust_access_code" name="cust_access_code" placeholder="enter password" required>

             <a href="customer-sign-up.php">Don't have an account? Sign Up now</a>
