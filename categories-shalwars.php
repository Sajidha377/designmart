...
<html>
  <head>
    <title>Design Mart | Categories | Shalwars</title>
...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/shalwar-banner.png" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/shalwar-banner1.png" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/shalwar-banner2.png" alt="Third slide">
    </div>
  </div>
</div>
<!-- end of banner -->
...
<div class="small-container">
  <h1>SHALWARS</h1>
  <p>Simple and most elegent women's wear. Best suited to be worn for any places likes religious places,
    colleges, office etc. </p>
</div>
<!-- end of small-container -->
  ...
  while($row = mysqli_fetch_assoc($rs)){
    ...
    <div class="col-4">
          <a data-fancybox="gallery" href="images/large/<?php echo $row['picture']; ?>"> <img src="images/large/<?php echo $row['picture']; ?>" alt="" data-toggle="modal" data-target="#shalwar" width="230px"></a>
          <table>
            <tr>
...
<div class="categories">
  ...
  <div class="small-container">
    ...
    <div class="row">
      ...
      <div class="col-5">
        <a href="categories-lehengas.php"><img src="images/lehenga1.jpg" alt=""></a>
        <h4>Lehenga</h4>
      </div>
      <!-- end of col-5 -->
