...
<html>
  <head>
    <title>Design Mart | Categories | Kurtis</title>
...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/kurti-banner.png" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/kurti-banner1.png" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/kurti-banner2.png" alt="Third slide">
    </div>
  </div>
</div>
<!-- end of banner -->
...
<div class="small-container">
  <h1>KURTIS</h1>
  <p>Kurtis, one of the most comfiest dress women prefer, anywhere anytime.
    Perfect outfit for everyday use, because it simple and comfortable.</p>
</div>
